...
class Leddiemdung extends Component {
	constructor(props) {
		super(props);
				...
				<div id="wrapper">
					<div id="header">
						<ul>
							...
							<li><a className="active" href="/Leddiemdung">Led điểm dừng</a></li>
					...
					<div id="content-section">
						...
						<table>
							...
							{listLed.map((Led) => (
								<tbody >
									<tr>
										<td style={{ fontWeight: 400 }}>{Led.id_ledDiemDung} </td>
	...
	async getLed() {
		const res = await fetch('http://localhost:8080/leddiemdung/all?sortType=1', {
			method: "get",
			headers: {
