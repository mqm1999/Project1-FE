...
class Ledtrong extends Component {
	constructor(props) {
		super(props);
				...
				<div id="wrapper">
					<div id="header">
						<ul>
							...
							<li><a className="active" href="/Ledtrong">led trong</a></li>
					...
					<div id="content-section">
						...
						<table>
							...
							{listLed.map((Led) => (
								<tbody >
									<tr>
										<td style={{ fontWeight: 400 }}>{Led.id_ledTrong} </td>
	...
	async getLed() {
		const res = await fetch('http://localhost:8080/ledtrong/all?sortType=1', {
			method: "get",
			headers: {
