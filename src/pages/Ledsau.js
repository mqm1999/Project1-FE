...
class Ledsau extends Component {
	constructor(props) {
		super(props);
				...
				<div id="wrapper">
					<div id="header">
						<ul>
							...
							<li><a className="active" href="/Ledsau">led sau</a></li>
					...
					<div id="content-section">
						...
						<table>
							...
							{listLed.map((Led) => (
								<tbody >
									<tr>
										<td style={{ fontWeight: 400 }}>{Led.id_ledSau} </td>
	...
	async getLed() {
		const res = await fetch('http://localhost:8080/ledsau/all?sortType=1', {
			method: "get",
			headers: {
